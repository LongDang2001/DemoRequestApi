...
import 'package:tiktok/DataBase/TestFireBaseTabPage.dart';
...
class MyHomePage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return MyHomePageState(analytics, observer);
  }
}
class MyHomePageState extends State<MyHomePage> {
  MyHomePageState(this.analytics, this.observer);

  final FirebaseAnalyticsObserver observer;
  final FirebaseAnalytics analytics;
  String _message = '';

  void setMessage(String messager) {
    setState(() {
      _message = messager;
    });
  }
